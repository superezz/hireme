...
const Features = () => {
  // added Feature Section from Prebuild Ui
  ...
  return (
    ...
    >
      ...
      <Title title='Build your resume' description='our streamlined process helps you create a professional resume in minutes with intelligant AI-poweres tools and features'/>
